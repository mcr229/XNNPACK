...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, bl_t_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .has_bias(false)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, odd_nc_t_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .batch_size(12)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, multithreaded_t_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .batch_size(12)
...
TEST(FULLY_CONNECTED_NC_QD8_F32_QB4W, bl_no_bias_t_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .has_bias(false)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, multithreaded) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .batch_size(12)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, bl_transpose_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .has_bias(false)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, multithreaded_transpose_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .batch_size(12)
...
TEST(FULLY_CONNECTED_NC_QD8_F16_QB4W, bl_no_bias_transpose_scales) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .has_bias(false)
...
TEST(FULLY_CONNECTED_NC_QP8_F32_QB4W, BL_BIAS_TRANSPOSE_SCALES) {
  for (size_t ic=32; ic<=256; ic*=2){
    for (size_t bs=32; bs<=ic; bs=bs*2) {
      FullyConnectedOperatorTester()
        .has_bias(true)
