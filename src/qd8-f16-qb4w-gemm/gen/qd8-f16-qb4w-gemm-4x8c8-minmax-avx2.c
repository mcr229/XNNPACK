...
void xnn_qd8_f16_qb4w_gemm_minmax_ukernel_4x8c8__avx2(
    size_t mr,
    size_t nc,
    size_t kc,
    ...
    const struct xnn_qd8_quantization_params quantization_params[restrict XNN_MIN_ELEMENTS(1)]) XNN_OOB_READS
{
  ...
  do {
    ...
    vout0x01 = _mm256_add_ps(vout0x01, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc0x01), vfilter_output_scale01));
    vout1x01 = _mm256_add_ps(vout1x01, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc1x01), vfilter_output_scale01));
    vout2x01 = _mm256_add_ps(vout2x01, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc2x01), vfilter_output_scale01));
    vout3x01 = _mm256_add_ps(vout3x01, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc3x01), vfilter_output_scale01));
    ...
    vout0x23 = _mm256_add_ps(vout0x23, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc0x23), vfilter_output_scale23));
    vout1x23 = _mm256_add_ps(vout1x23, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc1x23), vfilter_output_scale23));
    vout2x23 = _mm256_add_ps(vout2x23, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc2x23), vfilter_output_scale23));
    vout3x23 = _mm256_add_ps(vout3x23, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc3x23), vfilter_output_scale23));
    ...
    vout0x45 = _mm256_add_ps(vout0x45, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc0x45), vfilter_output_scale45));
    vout1x45 = _mm256_add_ps(vout1x45, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc1x45), vfilter_output_scale45));
    vout2x45 = _mm256_add_ps(vout2x45, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc2x45), vfilter_output_scale45));
    vout3x45 = _mm256_add_ps(vout3x45, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc3x45), vfilter_output_scale45));
    ...
    vout0x67 = _mm256_add_ps(vout0x67, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc0x67), vfilter_output_scale67));
    vout1x67 = _mm256_add_ps(vout1x67, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc1x67), vfilter_output_scale67));
    vout2x67 = _mm256_add_ps(vout2x67, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc2x67), vfilter_output_scale67));
    vout3x67 = _mm256_add_ps(vout3x67, _mm256_mul_ps(_mm256_cvtepi32_ps(vacc3x67), vfilter_output_scale67));
