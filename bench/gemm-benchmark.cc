...
void GEMMBenchmark(benchmark::State& state,
  ...
  const size_t packed_w_stride =
      packed_stride(&gemm_config, kc, /*unused_blocksize=*/0,/*k_stride=*/kc, /*extra_bytes=*/0);
  ...
  pack_weights(/*flags=*/0, &gemm_config, kc, nc,
               /*groups=*/1, /*unused_blocksize=*/0, /*k_stride=*/kc,
               ...
               /*packed_weights_ptr=*/w.data(), &packing_params, nullptr);
...
void GEMMBenchmark(benchmark::State& state,
  ...
  const size_t packed_w_stride =
      packed_stride(&gemm_config, k2, /*k_stride=*/bl, /*unused_k_stride=*/0, /*extra_bytes=*/0);
  const size_t packed_w_size = packed_w_stride * round_up(nc, nr);
  ...
  pack_weights(/*flags=*/0, &gemm_config, k2, nc,
               /*groups=*/1, /*block_size=*/bl, /*unused_k_stride=*/0,
               /*accumulator_init=*/nullptr,
               /*weights=*/k.data(),
               /*int_extra_data0_fn=*/nullptr,
               /*extra_data0=*/nullptr,
